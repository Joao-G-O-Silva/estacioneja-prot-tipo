    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p>
                Nossa missão é transformar a maneira como as instituições gerenciam seus espaços de estacionamento,
                tornando o processo mais eficiente, sustentável e acessível para todos.
              </p>
            </div>
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <div className="pl-6">
                  ...
                  <p className="text-muted-foreground">
                    Integração com sistemas de cancela e expansão para 100 instituições
                  </p>
                </div>
              </div>
              <div className="relative">
      ...
      <section className="w-full py-12 md:py-24 bg-primary text-white">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Junte-se a nós</h2>
              <p className="max-w-[600px] md:text-xl/relaxed">
                Faça parte da revolução na gestão de estacionamentos universitários
              </p>
            </div>
